...
export default function AboutPage() {
  return <div className="page page-about">
    <header className="cinematic-hero about-hero"><Image src="https://images.unsplash.com/photo-1529156069898-49953e39b3ac?w=1920&q=88" alt="Friends together in warm evening light" fill sizes="100vw" priority /><div className="cinematic-shade"/><div className="cinematic-copy"><p className="eyebrow">WHO WE ARE</p><h1>We build<br />hearths.</h1><p>Not audiences. Not funnels. Rooms where people can become honest again.</p></div></header>
    ...
    ].map((person, i) => <Reveal key={person[0]} delay={i * .08}><article><div className="portrait-reveal"><Image src={person[3]} alt={person[0]} fill sizes="(max-width: 520px) 100vw, (max-width: 760px) 50vw, 33vw"/><i/></div><div><span className="live-label"><i/>{person[1]}</span><h3>{person[0]}</h3><p>{person[2]}</p></div></article></Reveal>)}</div></section>
